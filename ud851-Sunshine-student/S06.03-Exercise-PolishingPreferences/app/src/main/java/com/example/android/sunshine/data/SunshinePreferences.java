...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        if(sharedPreferences != null){
            weatherLocation = sharedPreferences.getString(context.getString(R.string.pref_location_key),
    ...
    public static boolean isMetric(Context context) {
        ...
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        if(sharedPreferences != null){
            String unitsValue = sharedPreferences.getString(context.getString(R.string.pref_units_key), "");
            if(unitsValue.equals(context.getString(R.string.pref_units_metric)))
                return true;
            else
                return false;
        }
